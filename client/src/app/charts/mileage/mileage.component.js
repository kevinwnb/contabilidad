...
exports.MileageComponent = void 0;
const core_1 = require("@angular/core");
let MileageComponent = (() => {
    ...
    var MileageComponent = _classThis = class {
        constructor() {
    ...
    __setFunctionName(_classThis, "MileageComponent");
    (() => {
        ...
        MileageComponent = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return MileageComponent = _classThis;
})();
